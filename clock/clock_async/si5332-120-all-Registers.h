 ...
 * Timestamp:                                          2023-08-14 15:04:25 GMT-04:00
 *
 ...
 * Overview
 * ========
 * Part:               Si5332EFGHL Rev D
 * Project File:       F:\madorsky\cernbox\projects\silabs\apex\ku15p\si5332-120-all.slabtimeproj
 * Design ID:          <none>
 * Created By:         ClockBuilder Pro v4.1 [2021-09-22]
 * Timestamp:          2023-08-14 15:04:25 GMT-04:00
 * 
 ...
 * Frequency Plan Grade:     H
 * Minimum Base OPN:         Si5332H*
 * 
 ...
 * 
 * * Based on your calculated frequency plan, a Si5332H grade device is
 ...
 * 
 * Outputs:
 *    OUT0: 120 MHz LVDS Fast 1.8 V, Disabled-State: Stop Low
 *          Power-up state: Enabled
 *    OUT1: 120 MHz LVDS Fast 1.8 V, Disabled-State: Stop Low
 *          Power-up state: Enabled
 *    OUT2: 120 MHz LVDS Fast 1.8 V, Disabled-State: Stop Low
 *          Power-up state: Enabled
 *    OUT3: 120 MHz LVDS Fast 1.8 V, Disabled-State: Stop Low
 *          Power-up state: Enabled
 *    OUT4: 120 MHz LVDS Fast 1.8 V, Disabled-State: Stop Low
 *          Power-up state: Enabled
 *    OUT5: 120 MHz LVDS Fast 1.8 V, Disabled-State: Stop Low
 *          Power-up state: Enabled
 * 
 * Frequency Plan
 * ==============
 ...
 *    O0:
 *       Value: 20
 *       OUT0: 120 MHz, Error: 0 ppm
 *       OUT1: 120 MHz, Error: 0 ppm
 *       OUT2: 120 MHz, Error: 0 ppm
 *       OUT3: 120 MHz, Error: 0 ppm
 *       OUT4: 120 MHz, Error: 0 ppm
 *       OUT5: 120 MHz, Error: 0 ppm
 *    O1:
 *       Unused
 *    O2:
 *       Unused
 ...
 * Estimated Power
 * ===============
 * Total Power: 167 mW, On Chip Power: 158 mW, Tj: 30 °C
 * 
 *                  Frequency    Format   Voltage   Current     Power
 *                  ---------  --------  --------  --------  --------
 * VDD                                      1.8 V   20.7 mA     37 mW
 * VDD Dig                                  1.8 V    4.9 mA      9 mW
 * VDD Xtal                                 1.8 V    2.3 mA      4 mW
 * VDDO0                                                             
 *            OUT0    120 MHz  LVDSFast     1.8 V   10.8 mA     19 mW
 * VDDO1                                                             
 *            OUT1    120 MHz  LVDSFast     1.8 V   10.8 mA     19 mW
 * VDDO2                                                             
 *            OUT2    120 MHz  LVDSFast     1.8 V   10.8 mA     19 mW
 * VDDO3                                                             
 *            OUT3    120 MHz  LVDSFast     1.8 V   10.8 mA     19 mW
 * VDDO4                                                             
 *            OUT4    120 MHz  LVDSFast     1.8 V   10.8 mA     19 mW
 * VDDO5                                                             
 *            OUT5    120 MHz  LVDSFast     1.8 V   10.8 mA     19 mW
 *                                                 --------  --------
 *                                          Total   92.9 mA    167 mW
 * 
 * Note:
 * 
 ...
 * 0x67[14:0]  IDPA_INTG        6144               0x1800           
